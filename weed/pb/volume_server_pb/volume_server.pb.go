...
type ReadNeedleRangeRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	VolumeId      uint32                 `protobuf:"varint,1,opt,name=volume_id,json=volumeId,proto3" json:"volume_id,omitempty"`
...
func (x *ReadNeedleRangeRequest) Reset() {
	*x = ReadNeedleRangeRequest{}
	mi := &file_volume_server_proto_msgTypes[48]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *ReadNeedleRangeRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ReadNeedleRangeRequest) ProtoMessage() {}

func (x *ReadNeedleRangeRequest) ProtoReflect() protoreflect.Message {
	mi := &file_volume_server_proto_msgTypes[48]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ReadNeedleRangeRequest.ProtoReflect.Descriptor instead.
func (*ReadNeedleRangeRequest) Descriptor() ([]byte, []int) {
	return file_volume_server_proto_rawDescGZIP(), []int{48}
}

func (x *ReadNeedleRangeRequest) GetVolumeId() uint32 {
	if x != nil {
		return x.VolumeId
	}
	return 0
...
func (x *ReadNeedleRangeRequest) GetNeedleId() uint64 {
	if x != nil {
		return x.NeedleId
	}
	return 0
...
func (x *ReadNeedleRangeRequest) GetCookie() uint32 {
	if x != nil {
		return x.Cookie
	}
	return 0
...
func (x *ReadNeedleRangeRequest) GetOffset() uint64 {
	if x != nil {
		return x.Offset
	}
	return 0
...
func (x *ReadNeedleRangeRequest) GetSize() uint64 {
	if x != nil {
		return x.Size
	}
	return 0
...
type ReadNeedleRangeResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
...
func (x *ReadNeedleRangeResponse) Reset() {
	*x = ReadNeedleRangeResponse{}
	mi := &file_volume_server_proto_msgTypes[49]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *ReadNeedleRangeResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ReadNeedleRangeResponse) ProtoMessage() {}

func (x *ReadNeedleRangeResponse) ProtoReflect() protoreflect.Message {
	mi := &file_volume_server_proto_msgTypes[49]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ReadNeedleRangeResponse.ProtoReflect.Descriptor instead.
func (*ReadNeedleRangeResponse) Descriptor() ([]byte, []int) {
	return file_volume_server_proto_rawDescGZIP(), []int{49}
}

func (x *ReadNeedleRangeResponse) GetData() []byte {
	if x != nil {
		return x.Data
	}
	return nil
...
const file_volume_server_proto_rawDesc = "" +
	...
	"needleBlob\"\x96\x01\n" +
	"\x16ReadNeedleRangeRequest\x12\x1b\n" +
	...
	"\x17ReadNeedleRangeResponse\x12\x12\n" +
	...
	"\x0eReadNeedleBlob\x12'.volume_server_pb.ReadNeedleBlobRequest\x1a(.volume_server_pb.ReadNeedleBlobResponse\"\x00\x12h\n" +
	"\x0fReadNeedleRange\x12(.volume_server_pb.ReadNeedleRangeRequest\x1a).volume_server_pb.ReadNeedleRangeResponse\"\x00\x12e\n" +
...
var file_volume_server_proto_goTypes = []any{
	...
	(*ReadNeedleRangeRequest)(nil),                       // 49: volume_server_pb.ReadNeedleRangeRequest
	(*ReadNeedleRangeResponse)(nil),                      // 50: volume_server_pb.ReadNeedleRangeResponse
	(*ReadNeedleMetaRequest)(nil),                        // 51: volume_server_pb.ReadNeedleMetaRequest
	(*ReadNeedleMetaResponse)(nil),                       // 52: volume_server_pb.ReadNeedleMetaResponse
	(*WriteNeedleBlobRequest)(nil),                       // 53: volume_server_pb.WriteNeedleBlobRequest
	(*WriteNeedleBlobResponse)(nil),                      // 54: volume_server_pb.WriteNeedleBlobResponse
	(*ReadAllNeedlesRequest)(nil),                        // 55: volume_server_pb.ReadAllNeedlesRequest
	(*ReadAllNeedlesResponse)(nil),                       // 56: volume_server_pb.ReadAllNeedlesResponse
	(*VolumeTailSenderRequest)(nil),                      // 57: volume_server_pb.VolumeTailSenderRequest
	(*VolumeTailSenderResponse)(nil),                     // 58: volume_server_pb.VolumeTailSenderResponse
	(*VolumeTailReceiverRequest)(nil),                    // 59: volume_server_pb.VolumeTailReceiverRequest
	(*VolumeTailReceiverResponse)(nil),                   // 60: volume_server_pb.VolumeTailReceiverResponse
	(*VolumeEcShardsGenerateRequest)(nil),                // 61: volume_server_pb.VolumeEcShardsGenerateRequest
	(*VolumeEcShardsGenerateResponse)(nil),               // 62: volume_server_pb.VolumeEcShardsGenerateResponse
	(*VolumeEcShardsRebuildRequest)(nil),                 // 63: volume_server_pb.VolumeEcShardsRebuildRequest
	(*VolumeEcShardsRebuildResponse)(nil),                // 64: volume_server_pb.VolumeEcShardsRebuildResponse
	(*VolumeEcShardsCopyRequest)(nil),                    // 65: volume_server_pb.VolumeEcShardsCopyRequest
	(*VolumeEcShardsCopyResponse)(nil),                   // 66: volume_server_pb.VolumeEcShardsCopyResponse
	(*VolumeEcShardsDeleteRequest)(nil),                  // 67: volume_server_pb.VolumeEcShardsDeleteRequest
	(*VolumeEcShardsDeleteResponse)(nil),                 // 68: volume_server_pb.VolumeEcShardsDeleteResponse
	(*VolumeEcShardsMountRequest)(nil),                   // 69: volume_server_pb.VolumeEcShardsMountRequest
	(*VolumeEcShardsMountResponse)(nil),                  // 70: volume_server_pb.VolumeEcShardsMountResponse
	(*VolumeEcShardsUnmountRequest)(nil),                 // 71: volume_server_pb.VolumeEcShardsUnmountRequest
	(*VolumeEcShardsUnmountResponse)(nil),                // 72: volume_server_pb.VolumeEcShardsUnmountResponse
	(*VolumeEcShardReadRequest)(nil),                     // 73: volume_server_pb.VolumeEcShardReadRequest
	(*VolumeEcShardReadResponse)(nil),                    // 74: volume_server_pb.VolumeEcShardReadResponse
	(*VolumeEcBlobDeleteRequest)(nil),                    // 75: volume_server_pb.VolumeEcBlobDeleteRequest
	(*VolumeEcBlobDeleteResponse)(nil),                   // 76: volume_server_pb.VolumeEcBlobDeleteResponse
	(*VolumeEcShardsToVolumeRequest)(nil),                // 77: volume_server_pb.VolumeEcShardsToVolumeRequest
	(*VolumeEcShardsToVolumeResponse)(nil),               // 78: volume_server_pb.VolumeEcShardsToVolumeResponse
	(*VolumeEcShardsInfoRequest)(nil),                    // 79: volume_server_pb.VolumeEcShardsInfoRequest
	(*VolumeEcShardsInfoResponse)(nil),                   // 80: volume_server_pb.VolumeEcShardsInfoResponse
	(*EcShardInfo)(nil),                                  // 81: volume_server_pb.EcShardInfo
	(*ReadVolumeFileStatusRequest)(nil),                  // 82: volume_server_pb.ReadVolumeFileStatusRequest
	(*ReadVolumeFileStatusResponse)(nil),                 // 83: volume_server_pb.ReadVolumeFileStatusResponse
	(*DiskStatus)(nil),                                   // 84: volume_server_pb.DiskStatus
	(*MemStatus)(nil),                                    // 85: volume_server_pb.MemStatus
	(*RemoteFile)(nil),                                   // 86: volume_server_pb.RemoteFile
	(*VolumeInfo)(nil),                                   // 87: volume_server_pb.VolumeInfo
	(*EcShardConfig)(nil),                                // 88: volume_server_pb.EcShardConfig
	(*OldVersionVolumeInfo)(nil),                         // 89: volume_server_pb.OldVersionVolumeInfo
	(*VolumeTierMoveDatToRemoteRequest)(nil),             // 90: volume_server_pb.VolumeTierMoveDatToRemoteRequest
	(*VolumeTierMoveDatToRemoteResponse)(nil),            // 91: volume_server_pb.VolumeTierMoveDatToRemoteResponse
	(*VolumeTierMoveDatFromRemoteRequest)(nil),           // 92: volume_server_pb.VolumeTierMoveDatFromRemoteRequest
	(*VolumeTierMoveDatFromRemoteResponse)(nil),          // 93: volume_server_pb.VolumeTierMoveDatFromRemoteResponse
	(*VolumeServerStatusRequest)(nil),                    // 94: volume_server_pb.VolumeServerStatusRequest
	(*VolumeServerStatusResponse)(nil),                   // 95: volume_server_pb.VolumeServerStatusResponse
	(*VolumeServerLeaveRequest)(nil),                     // 96: volume_server_pb.VolumeServerLeaveRequest
	(*VolumeServerLeaveResponse)(nil),                    // 97: volume_server_pb.VolumeServerLeaveResponse
	(*FetchAndWriteNeedleRequest)(nil),                   // 98: volume_server_pb.FetchAndWriteNeedleRequest
	(*FetchAndWriteNeedleResponse)(nil),                  // 99: volume_server_pb.FetchAndWriteNeedleResponse
	(*ScrubVolumeRequest)(nil),                           // 100: volume_server_pb.ScrubVolumeRequest
	(*ScrubVolumeResponse)(nil),                          // 101: volume_server_pb.ScrubVolumeResponse
	(*ScrubEcVolumeRequest)(nil),                         // 102: volume_server_pb.ScrubEcVolumeRequest
	(*ScrubEcVolumeResponse)(nil),                        // 103: volume_server_pb.ScrubEcVolumeResponse
	(*QueryRequest)(nil),                                 // 104: volume_server_pb.QueryRequest
	(*QueriedStripe)(nil),                                // 105: volume_server_pb.QueriedStripe
	(*VolumeNeedleStatusRequest)(nil),                    // 106: volume_server_pb.VolumeNeedleStatusRequest
	(*VolumeNeedleStatusResponse)(nil),                   // 107: volume_server_pb.VolumeNeedleStatusResponse
	(*PingRequest)(nil),                                  // 108: volume_server_pb.PingRequest
	(*PingResponse)(nil),                                 // 109: volume_server_pb.PingResponse
	(*FetchAndWriteNeedleRequest_Replica)(nil),           // 110: volume_server_pb.FetchAndWriteNeedleRequest.Replica
	(*QueryRequest_Filter)(nil),                          // 111: volume_server_pb.QueryRequest.Filter
	(*QueryRequest_InputSerialization)(nil),              // 112: volume_server_pb.QueryRequest.InputSerialization
	(*QueryRequest_OutputSerialization)(nil),             // 113: volume_server_pb.QueryRequest.OutputSerialization
	(*QueryRequest_InputSerialization_CSVInput)(nil),     // 114: volume_server_pb.QueryRequest.InputSerialization.CSVInput
	(*QueryRequest_InputSerialization_JSONInput)(nil),    // 115: volume_server_pb.QueryRequest.InputSerialization.JSONInput
	(*QueryRequest_InputSerialization_ParquetInput)(nil), // 116: volume_server_pb.QueryRequest.InputSerialization.ParquetInput
	(*QueryRequest_OutputSerialization_CSVOutput)(nil),   // 117: volume_server_pb.QueryRequest.OutputSerialization.CSVOutput
	(*QueryRequest_OutputSerialization_JSONOutput)(nil),  // 118: volume_server_pb.QueryRequest.OutputSerialization.JSONOutput
	(*remote_pb.RemoteConf)(nil),                         // 119: remote_pb.RemoteConf
	(*remote_pb.RemoteStorageLocation)(nil),              // 120: remote_pb.RemoteStorageLocation
}
var file_volume_server_proto_depIdxs = []int32{
	...
	81,  // 5: volume_server_pb.VolumeEcShardsInfoResponse.ec_shard_infos:type_name -> volume_server_pb.EcShardInfo
	87,  // 6: volume_server_pb.ReadVolumeFileStatusResponse.volume_info:type_name -> volume_server_pb.VolumeInfo
	86,  // 7: volume_server_pb.VolumeInfo.files:type_name -> volume_server_pb.RemoteFile
	88,  // 8: volume_server_pb.VolumeInfo.ec_shard_config:type_name -> volume_server_pb.EcShardConfig
	86,  // 9: volume_server_pb.OldVersionVolumeInfo.files:type_name -> volume_server_pb.RemoteFile
	84,  // 10: volume_server_pb.VolumeServerStatusResponse.disk_statuses:type_name -> volume_server_pb.DiskStatus
	85,  // 11: volume_server_pb.VolumeServerStatusResponse.memory_status:type_name -> volume_server_pb.MemStatus
	1,   // 12: volume_server_pb.VolumeServerStatusResponse.state:type_name -> volume_server_pb.VolumeServerState
	110, // 13: volume_server_pb.FetchAndWriteNeedleRequest.replicas:type_name -> volume_server_pb.FetchAndWriteNeedleRequest.Replica
	119, // 14: volume_server_pb.FetchAndWriteNeedleRequest.remote_conf:type_name -> remote_pb.RemoteConf
	120, // 15: volume_server_pb.FetchAndWriteNeedleRequest.remote_location:type_name -> remote_pb.RemoteStorageLocation
	...
	81,  // 18: volume_server_pb.ScrubEcVolumeResponse.broken_shard_infos:type_name -> volume_server_pb.EcShardInfo
	111, // 19: volume_server_pb.QueryRequest.filter:type_name -> volume_server_pb.QueryRequest.Filter
	112, // 20: volume_server_pb.QueryRequest.input_serialization:type_name -> volume_server_pb.QueryRequest.InputSerialization
	113, // 21: volume_server_pb.QueryRequest.output_serialization:type_name -> volume_server_pb.QueryRequest.OutputSerialization
	114, // 22: volume_server_pb.QueryRequest.InputSerialization.csv_input:type_name -> volume_server_pb.QueryRequest.InputSerialization.CSVInput
	115, // 23: volume_server_pb.QueryRequest.InputSerialization.json_input:type_name -> volume_server_pb.QueryRequest.InputSerialization.JSONInput
	116, // 24: volume_server_pb.QueryRequest.InputSerialization.parquet_input:type_name -> volume_server_pb.QueryRequest.InputSerialization.ParquetInput
	117, // 25: volume_server_pb.QueryRequest.OutputSerialization.csv_output:type_name -> volume_server_pb.QueryRequest.OutputSerialization.CSVOutput
	118, // 26: volume_server_pb.QueryRequest.OutputSerialization.json_output:type_name -> volume_server_pb.QueryRequest.OutputSerialization.JSONOutput
	...
	82,  // 46: volume_server_pb.VolumeServer.ReadVolumeFileStatus:input_type -> volume_server_pb.ReadVolumeFileStatusRequest
	...
	49,  // 50: volume_server_pb.VolumeServer.ReadNeedleRange:input_type -> volume_server_pb.ReadNeedleRangeRequest
	51,  // 51: volume_server_pb.VolumeServer.ReadNeedleMeta:input_type -> volume_server_pb.ReadNeedleMetaRequest
	53,  // 52: volume_server_pb.VolumeServer.WriteNeedleBlob:input_type -> volume_server_pb.WriteNeedleBlobRequest
	55,  // 53: volume_server_pb.VolumeServer.ReadAllNeedles:input_type -> volume_server_pb.ReadAllNeedlesRequest
	57,  // 54: volume_server_pb.VolumeServer.VolumeTailSender:input_type -> volume_server_pb.VolumeTailSenderRequest
	59,  // 55: volume_server_pb.VolumeServer.VolumeTailReceiver:input_type -> volume_server_pb.VolumeTailReceiverRequest
	61,  // 56: volume_server_pb.VolumeServer.VolumeEcShardsGenerate:input_type -> volume_server_pb.VolumeEcShardsGenerateRequest
	63,  // 57: volume_server_pb.VolumeServer.VolumeEcShardsRebuild:input_type -> volume_server_pb.VolumeEcShardsRebuildRequest
	65,  // 58: volume_server_pb.VolumeServer.VolumeEcShardsCopy:input_type -> volume_server_pb.VolumeEcShardsCopyRequest
	67,  // 59: volume_server_pb.VolumeServer.VolumeEcShardsDelete:input_type -> volume_server_pb.VolumeEcShardsDeleteRequest
	69,  // 60: volume_server_pb.VolumeServer.VolumeEcShardsMount:input_type -> volume_server_pb.VolumeEcShardsMountRequest
	71,  // 61: volume_server_pb.VolumeServer.VolumeEcShardsUnmount:input_type -> volume_server_pb.VolumeEcShardsUnmountRequest
	73,  // 62: volume_server_pb.VolumeServer.VolumeEcShardRead:input_type -> volume_server_pb.VolumeEcShardReadRequest
	75,  // 63: volume_server_pb.VolumeServer.VolumeEcBlobDelete:input_type -> volume_server_pb.VolumeEcBlobDeleteRequest
	77,  // 64: volume_server_pb.VolumeServer.VolumeEcShardsToVolume:input_type -> volume_server_pb.VolumeEcShardsToVolumeRequest
	79,  // 65: volume_server_pb.VolumeServer.VolumeEcShardsInfo:input_type -> volume_server_pb.VolumeEcShardsInfoRequest
	90,  // 66: volume_server_pb.VolumeServer.VolumeTierMoveDatToRemote:input_type -> volume_server_pb.VolumeTierMoveDatToRemoteRequest
	92,  // 67: volume_server_pb.VolumeServer.VolumeTierMoveDatFromRemote:input_type -> volume_server_pb.VolumeTierMoveDatFromRemoteRequest
	94,  // 68: volume_server_pb.VolumeServer.VolumeServerStatus:input_type -> volume_server_pb.VolumeServerStatusRequest
	96,  // 69: volume_server_pb.VolumeServer.VolumeServerLeave:input_type -> volume_server_pb.VolumeServerLeaveRequest
	98,  // 70: volume_server_pb.VolumeServer.FetchAndWriteNeedle:input_type -> volume_server_pb.FetchAndWriteNeedleRequest
	100, // 71: volume_server_pb.VolumeServer.ScrubVolume:input_type -> volume_server_pb.ScrubVolumeRequest
	102, // 72: volume_server_pb.VolumeServer.ScrubEcVolume:input_type -> volume_server_pb.ScrubEcVolumeRequest
	104, // 73: volume_server_pb.VolumeServer.Query:input_type -> volume_server_pb.QueryRequest
	106, // 74: volume_server_pb.VolumeServer.VolumeNeedleStatus:input_type -> volume_server_pb.VolumeNeedleStatusRequest
	108, // 75: volume_server_pb.VolumeServer.Ping:input_type -> volume_server_pb.PingRequest
	3,   // 76: volume_server_pb.VolumeServer.BatchDelete:output_type -> volume_server_pb.BatchDeleteResponse
	7,   // 77: volume_server_pb.VolumeServer.VacuumVolumeCheck:output_type -> volume_server_pb.VacuumVolumeCheckResponse
	9,   // 78: volume_server_pb.VolumeServer.VacuumVolumeCompact:output_type -> volume_server_pb.VacuumVolumeCompactResponse
	11,  // 79: volume_server_pb.VolumeServer.VacuumVolumeCommit:output_type -> volume_server_pb.VacuumVolumeCommitResponse
	13,  // 80: volume_server_pb.VolumeServer.VacuumVolumeCleanup:output_type -> volume_server_pb.VacuumVolumeCleanupResponse
	15,  // 81: volume_server_pb.VolumeServer.DeleteCollection:output_type -> volume_server_pb.DeleteCollectionResponse
	17,  // 82: volume_server_pb.VolumeServer.AllocateVolume:output_type -> volume_server_pb.AllocateVolumeResponse
	19,  // 83: volume_server_pb.VolumeServer.VolumeSyncStatus:output_type -> volume_server_pb.VolumeSyncStatusResponse
	21,  // 84: volume_server_pb.VolumeServer.VolumeIncrementalCopy:output_type -> volume_server_pb.VolumeIncrementalCopyResponse
	23,  // 85: volume_server_pb.VolumeServer.VolumeMount:output_type -> volume_server_pb.VolumeMountResponse
	25,  // 86: volume_server_pb.VolumeServer.VolumeUnmount:output_type -> volume_server_pb.VolumeUnmountResponse
	27,  // 87: volume_server_pb.VolumeServer.VolumeDelete:output_type -> volume_server_pb.VolumeDeleteResponse
	29,  // 88: volume_server_pb.VolumeServer.VolumeMarkReadonly:output_type -> volume_server_pb.VolumeMarkReadonlyResponse
	31,  // 89: volume_server_pb.VolumeServer.VolumeMarkWritable:output_type -> volume_server_pb.VolumeMarkWritableResponse
	33,  // 90: volume_server_pb.VolumeServer.VolumeConfigure:output_type -> volume_server_pb.VolumeConfigureResponse
	35,  // 91: volume_server_pb.VolumeServer.VolumeStatus:output_type -> volume_server_pb.VolumeStatusResponse
	37,  // 92: volume_server_pb.VolumeServer.GetState:output_type -> volume_server_pb.GetStateResponse
	39,  // 93: volume_server_pb.VolumeServer.SetState:output_type -> volume_server_pb.SetStateResponse
	41,  // 94: volume_server_pb.VolumeServer.VolumeCopy:output_type -> volume_server_pb.VolumeCopyResponse
	83,  // 95: volume_server_pb.VolumeServer.ReadVolumeFileStatus:output_type -> volume_server_pb.ReadVolumeFileStatusResponse
	43,  // 96: volume_server_pb.VolumeServer.CopyFile:output_type -> volume_server_pb.CopyFileResponse
	46,  // 97: volume_server_pb.VolumeServer.ReceiveFile:output_type -> volume_server_pb.ReceiveFileResponse
	48,  // 98: volume_server_pb.VolumeServer.ReadNeedleBlob:output_type -> volume_server_pb.ReadNeedleBlobResponse
	50,  // 99: volume_server_pb.VolumeServer.ReadNeedleRange:output_type -> volume_server_pb.ReadNeedleRangeResponse
	52,  // 100: volume_server_pb.VolumeServer.ReadNeedleMeta:output_type -> volume_server_pb.ReadNeedleMetaResponse
	54,  // 101: volume_server_pb.VolumeServer.WriteNeedleBlob:output_type -> volume_server_pb.WriteNeedleBlobResponse
	56,  // 102: volume_server_pb.VolumeServer.ReadAllNeedles:output_type -> volume_server_pb.ReadAllNeedlesResponse
	58,  // 103: volume_server_pb.VolumeServer.VolumeTailSender:output_type -> volume_server_pb.VolumeTailSenderResponse
	60,  // 104: volume_server_pb.VolumeServer.VolumeTailReceiver:output_type -> volume_server_pb.VolumeTailReceiverResponse
	62,  // 105: volume_server_pb.VolumeServer.VolumeEcShardsGenerate:output_type -> volume_server_pb.VolumeEcShardsGenerateResponse
	64,  // 106: volume_server_pb.VolumeServer.VolumeEcShardsRebuild:output_type -> volume_server_pb.VolumeEcShardsRebuildResponse
	66,  // 107: volume_server_pb.VolumeServer.VolumeEcShardsCopy:output_type -> volume_server_pb.VolumeEcShardsCopyResponse
	68,  // 108: volume_server_pb.VolumeServer.VolumeEcShardsDelete:output_type -> volume_server_pb.VolumeEcShardsDeleteResponse
	70,  // 109: volume_server_pb.VolumeServer.VolumeEcShardsMount:output_type -> volume_server_pb.VolumeEcShardsMountResponse
	72,  // 110: volume_server_pb.VolumeServer.VolumeEcShardsUnmount:output_type -> volume_server_pb.VolumeEcShardsUnmountResponse
	74,  // 111: volume_server_pb.VolumeServer.VolumeEcShardRead:output_type -> volume_server_pb.VolumeEcShardReadResponse
	76,  // 112: volume_server_pb.VolumeServer.VolumeEcBlobDelete:output_type -> volume_server_pb.VolumeEcBlobDeleteResponse
	78,  // 113: volume_server_pb.VolumeServer.VolumeEcShardsToVolume:output_type -> volume_server_pb.VolumeEcShardsToVolumeResponse
	80,  // 114: volume_server_pb.VolumeServer.VolumeEcShardsInfo:output_type -> volume_server_pb.VolumeEcShardsInfoResponse
	91,  // 115: volume_server_pb.VolumeServer.VolumeTierMoveDatToRemote:output_type -> volume_server_pb.VolumeTierMoveDatToRemoteResponse
	93,  // 116: volume_server_pb.VolumeServer.VolumeTierMoveDatFromRemote:output_type -> volume_server_pb.VolumeTierMoveDatFromRemoteResponse
	95,  // 117: volume_server_pb.VolumeServer.VolumeServerStatus:output_type -> volume_server_pb.VolumeServerStatusResponse
	97,  // 118: volume_server_pb.VolumeServer.VolumeServerLeave:output_type -> volume_server_pb.VolumeServerLeaveResponse
	99,  // 119: volume_server_pb.VolumeServer.FetchAndWriteNeedle:output_type -> volume_server_pb.FetchAndWriteNeedleResponse
	101, // 120: volume_server_pb.VolumeServer.ScrubVolume:output_type -> volume_server_pb.ScrubVolumeResponse
	103, // 121: volume_server_pb.VolumeServer.ScrubEcVolume:output_type -> volume_server_pb.ScrubEcVolumeResponse
	105, // 122: volume_server_pb.VolumeServer.Query:output_type -> volume_server_pb.QueriedStripe
	107, // 123: volume_server_pb.VolumeServer.VolumeNeedleStatus:output_type -> volume_server_pb.VolumeNeedleStatusResponse
	109, // 124: volume_server_pb.VolumeServer.Ping:output_type -> volume_server_pb.PingResponse
