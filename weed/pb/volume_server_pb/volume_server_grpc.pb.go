...
const (
	...
	VolumeServer_ReadNeedleRange_FullMethodName             = "/volume_server_pb.VolumeServer/ReadNeedleRange"
...
type VolumeServerClient interface {
	...
	ReadNeedleRange(ctx context.Context, in *ReadNeedleRangeRequest, opts ...grpc.CallOption) (*ReadNeedleRangeResponse, error)
...
func (c *volumeServerClient) ReadNeedleRange(ctx context.Context, in *ReadNeedleRangeRequest, opts ...grpc.CallOption) (*ReadNeedleRangeResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ReadNeedleRangeResponse)
	err := c.cc.Invoke(ctx, VolumeServer_ReadNeedleRange_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type VolumeServerServer interface {
	...
	ReadNeedleRange(context.Context, *ReadNeedleRangeRequest) (*ReadNeedleRangeResponse, error)
...
func (UnimplementedVolumeServerServer) ReadNeedleRange(context.Context, *ReadNeedleRangeRequest) (*ReadNeedleRangeResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ReadNeedleRange not implemented")
}
...
func _VolumeServer_ReadNeedleRange_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ReadNeedleRangeRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(VolumeServerServer).ReadNeedleRange(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: VolumeServer_ReadNeedleRange_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(VolumeServerServer).ReadNeedleRange(ctx, req.(*ReadNeedleRangeRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var VolumeServer_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "ReadNeedleRange",
			Handler:    _VolumeServer_ReadNeedleRange_Handler,
		},
		{
