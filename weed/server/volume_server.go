...
func NewVolumeServer(adminMux, publicMux *http.ServeMux, ip string,
	...
	adminMux.HandleFunc(VolumeRdmaNativeReadDescBatchPath, requestIDMiddleware(vs.guard.WhiteList(vs.volumeRdmaReadDescBatchHandler)))
	...
	adminMux.HandleFunc(VolumeRdmaNativeReleaseDescBatchPath, requestIDMiddleware(vs.guard.WhiteList(vs.volumeRdmaReleaseDescBatchHandler)))
