...
impl RdmaError {
    ...
    pub fn is_recoverable(&self) -> bool {
        match self {
            ...
            Self::SessionNotFound { .. } | Self::SessionExpired { .. } => true,
            ...
            Self::IpcError { .. } | Self::SerializationError { .. } => true,
    ...
    pub fn category(&self) -> &'static str {
        match self {
            ...
            Self::IpcError { .. } | Self::SerializationError { .. } => "ipc",

            Self::InvalidRequest { .. } => "request",

            Self::InsufficientBuffer { .. } | Self::ResourceExhausted { .. } => "capacity",
...
impl From<i32> for RdmaError {
    fn from(errno: i32) -> Self {
        match errno {
            ...
            libc::ETIMEDOUT => Self::NetworkTimeout { timeout_ms: 5000 },
...
mod tests {
    ...
    fn test_error_recoverability() {
        ...
        assert!(!RdmaError::DeviceNotFound {
            device: "test".to_string()
        }
        .is_recoverable());
        assert!(RdmaError::SessionExpired {
    ...
    fn test_error_display() {
        let err = RdmaError::InvalidRequest {
